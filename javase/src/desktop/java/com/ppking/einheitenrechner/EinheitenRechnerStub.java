 ...
 * @author Shai Almog
 */
public class EinheitenRechnerStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "EinheitenRechner";
    ...
    private EinheitenRechner mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new EinheitenRechnerStub());
    }
